...
const executeNodeScript = function (scriptPath, url) {
...
const startBrowserProcess = function (browser, url, args) {
  ...
  if (shouldTryOpenChromiumWithAppleScript) {
    ...
    for (const chromiumBrowser of supportedChromiumBrowsers) {
      try {
        ...
        execSync(`osascript ${join(__dirname, 'openChrome.applescript')} "${encodeURI(url)}" "${chromiumBrowser}"`, {
          cwd: __dirname,
          stdio: 'ignore',
        })
        return true

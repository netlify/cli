...
// A logical reset needs a running database, which is exactly what a damaged
// data directory can't give us. Deleting the directory gets the user to the
// same place: an empty database on the next start.

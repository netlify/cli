...
const graphOperations = async (options, command) => {
    ...
    try {
        ...
        Object.values(functions).sort((aItem, bItem) => aItem.operationName.localeCompare(bItem.operationName)).forEach(operation => {
        ...
        Object.values(fragments).sort((aItem, bItem) => aItem.fragmentName.localeCompare(bItem.fragmentName)).forEach(fragment => {

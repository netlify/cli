...
import { chalk, error, exit, logWarn } from '../../utils/command-helpers.mjs'
...
const functionsInvoke = async (nameArgument, options, command) => {
  ...
  if (!options.port)
    logWarn({ message: `"port" flag was not specified. Attempting to connect to localhost:8888 by default` })

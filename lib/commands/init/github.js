    ...
    return fn.call(inquire.prompt, [
      ...
      return confirm.withConfirmation({msg: "Looking good?", default: "yes"}).then(function() {
        return withGithubClient(config).then(function(github) {
          return fn.call(github.repos.get, {user: repo.user, repo: repo.repo}).then(function(ghRepo) {
            ...
            return config.client.createDeployKey({}).then(function(key) {
              ...
              return fn.call(github.repos.createKey, {
                user: repo.user,
                repo: repo.repo,
                ...
                return config.client.createSite({
                  ...
                  return fn.call(github.repos.createHook,{
                    provider: "github",
                    user: repo.user,
                    repo: repo.repo,
                    name: "web",

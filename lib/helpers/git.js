...
exports.getGitHost = function(remote, opt_callback) {
  exports.getRemoteUrl(remote, function(err, data) {
    opt_callback(err, exports.getGitHostFromRemoteUrl(data));
  });
};
...
exports.getRepoDetails = function(cb) {
  exports.getRemoteUrl("origin", function(err, url) {
    if (err) { return cb(err); }
    exports.getCurrentBranch(function(err, branch) {
      if (err) { return cb(err); }
      cb(null,{
        url: url,

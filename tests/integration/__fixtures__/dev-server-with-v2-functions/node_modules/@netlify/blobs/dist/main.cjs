...
var getEnvironmentContext = () => {
  if (!import_node_process.env[NETLIFY_CONTEXT_VARIABLE]) {
    return {};
  }
  const data = import_node_buffer.Buffer.from(import_node_process.env[NETLIFY_CONTEXT_VARIABLE], "base64").toString();
  try {

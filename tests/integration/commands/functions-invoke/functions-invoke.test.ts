...
describe('functions:invoke command', async () => {
  await setupFixtureTests('dev-server-with-functions', { devServer: true }, () => {
    test.concurrent<FixtureTestContext>('should return function response when invoked with no identity argument', async ({
      devServer,
      expect,
      fixture,
    }) => {
    ...
    test.concurrent<FixtureTestContext>('should return function response when invoked', async ({
      devServer,
      expect,
      fixture,
    }) => {
    ...
    test.concurrent<FixtureTestContext>('should trigger background function from event', async ({
      devServer,
      expect,
      fixture,
    }) => {
    ...
    test.concurrent<FixtureTestContext>('should serve helpful tips and tricks', async ({
      devServer,
      expect,
      fixture,
    }) => {
    ...
    test.concurrent<FixtureTestContext>('should detect netlify-toml defined scheduled functions', async ({
      devServer,
      expect,
      fixture,
    }) => {

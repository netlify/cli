...
const { extractFunctionsFromOperationDoc, generateFunctionsSource, generateHandlerSource } = require('../src/lib/one-graph/netlify-graph')
...
test('netlify graph handler codegen', (t) => {
    ...
    const generatedHandler = generateHandlerSource({ netligraphConfig, schema, operationsDoc: appOperationsDoc, operationId, handlerOptions })

...
> Snapshot 1
    ...
    `◈ Netlify Dev ◈␊
    ◈ Invalid framework "to-infinity-and-beyond-js". It should be one of: angular, assemble, astro, blitz, brunch, cecil, create-react-app, docpad, docusaurus, docusaurus-v2, eleventy, ember, expo, gatsby, gridsome, grunt, gulp, harp, hexo, hugo, jekyll, metalsmith, middleman, next, next-nx, nuxt, parcel, phenomic, quasar, quasar-v0.17, react-static, redwoodjs, roots, sapper, stencil, svelte, svelte-kit, vite, vue, vuepress, wintersmith, wmr, zola`

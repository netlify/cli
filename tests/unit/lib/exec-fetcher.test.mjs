...
import { fetchLatestVersion, getArch, getExecName } from '../../../src/lib/exec-fetcher.mjs'
...
test('should provide the error if it is not a 404', async () => {
  ...
  fetchLatest.mockReturnValue(Promise.reject(error))
...
test('should not throw when the request passes', async () => {
  fetchLatest.mockReturnValue(Promise.resolve())

...
import uploadFiles from '../../../../src/utils/deploy/upload-files.mjs'

vi.mock('../../../../src/utils/deploy/constants.mjs', async () => {
  const actual = await vi.importActual('../../../../src/utils/deploy/constants.mjs')
